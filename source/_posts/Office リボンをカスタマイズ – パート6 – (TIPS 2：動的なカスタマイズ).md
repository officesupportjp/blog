...
今回の記事では、[前回の投稿](https://social.msdn.microsoft.com/Forums/ja-JP/92c79484-7a8c-40ba-9bfa-aee91ba844c7/office-12522125081253112434124591247312479125101245212474-8211?forum=officesupportteamja)に引き続き、リボン カスタマイズ方法の例をご紹介します。

[以前の投稿](https://social.msdn.microsoft.com/Forums/ja-JP/cc7d3fef-659a-4527-a7ed-11ad87eacc1b/office-12522125081253112434124591247312479125101245212474-8211?forum=officesupportteamja)で紹介した方法で、リボンのカスタマイズがファイル単位でできることはお伝えしましたが、以下のような状況の開発者の方もいるのではないでしょうか。

...
まずは、以前の投稿 ([Office リボンをカスタマイズ – パート3 – (VSTO ビジュアルなデザイナーでカスタマイズ)](https://social.msdn.microsoft.com/Forums/ja-JP/7738215e-000a-4fdc-903f-261aa62ee371/office-3-vsto-)) の手順で、ひな形となるサンプル Excel アドインを作成します。今回は、ソリューションの名前を「SampleExcelAddin\_XML」にします。
